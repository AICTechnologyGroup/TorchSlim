...
from optimization.quantization.core import get_bits_length
from optimization.quantization.core import BN_FOLD_TAG
...
class LsqQuantizer(Quantizer):
    ...
    def _del_simulated_attr(self, module):
        ...
        """
        del_attr_list = ['old_weight', 'tracked_min_input', 'tracked_max_input', 'tracked_min_output', 'tracked_max_output', 'output_scale', 'input_scale', 'weight_scale','weight_bits', 'output_bits', 'input_bits', 'BN_FOLD_TAG']
